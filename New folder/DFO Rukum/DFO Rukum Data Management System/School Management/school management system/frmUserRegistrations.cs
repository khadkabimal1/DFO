...
namespace school_management_system
{
    public partial class frmUserRegistrations : Form
    {
        ...
        public void auto()
        {
            try
            {
                ...
                if (Convert.IsDBNull(cmd.ExecuteScalar()))
                {
                    ...
                    UserID.Text = Convert.ToString("User_" + Num);
                }
                else
                {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Super User Can not be Deleted.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtID.Focus();
                return;
            }
            try
        ...
        public void Fill()
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBcon);
                con.Open();
                string ct1 = "SELECT distinct RTRIM(Staffname) FROM Employee ";
